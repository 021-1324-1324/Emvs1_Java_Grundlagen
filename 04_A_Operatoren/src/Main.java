public class Main {
    public static void main(String[] args) {
        ...
        // ++ means that it goes +1 and -- means that it goes -1
        ...
        // If there is a ! then it does the oposite
        ...
        //because one is min and the other one is max
        ...
        //     It doesn't work because of it is a string
        ...
        int viewCount = 2_147_438_647; // Set a reasonable value here (See excersice 9 for help)
        System.out.println(viewCount); //  Should show: 2_147_483_647
        viewCount = ++viewCount; // Set a reasonable value here again
        //++viewCount
        System.out.println(viewCount); // Should show: -2_147_483_648 (underscore for readability)
        viewCount = viewCount + 5000000; // Set a reasonable value here again
        ...
        int x = 1;
        x = x++ + ++x;
        System.out.println(x); // because of the + ++x thats why
